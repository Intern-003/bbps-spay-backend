...
return new class extends Migration
{
    ...
    {
        Schema::create('complaint_track', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('complaint_register_id')->constrained('complaint_register')->onDelete('cascade');
            ...
            $table->string('complaint_assigned')->nullable(); //no param named 'complaint_assigned' coming in response
    ...
    {
        Schema::dropIfExists('complaint_track');
    }
};
